            ...
            >
                <motion.div variants={itemVariants} className='max-w-4xl mx-auto text-center mb-20'>
                    <h2 className='font-display'>
                        ...
                        <span className='block text-3xl md:text-5xl font-bold bg-gradient-to-r from-blue-400 via-blue-500 to-purple-500 bg-clip-text text-transparent tracking-tight'>
                            이제는 달라져야 합니다
                        </span>
                    </h2>
                </motion.div>
                        ...
                        >
                            ...
                            <div className='relative bg-gradient-to-br from-gray-900/90 to-gray-800/90 border border-gray-800 group-hover:border-blue-500/50 rounded-2xl p-8 backdrop-blur-sm transition-all duration-500 h-full transform-gpu group-hover:translate-y-[-0.5rem] group-hover:shadow-2xl group-hover:shadow-blue-500/10'>
                                ...
                                <div className='space-y-4'>
                                    ...
                                    {"stat" in item ? (
                                        <div className='bg-blue-500/10 rounded-xl p-4 text-center mt-4'>
                                        ...
                                        <div className='grid grid-cols-2 gap-4 mt-4'>
                                            {item.stats.map((stat, index) => (
                                                <div key={index} className='bg-blue-500/10 rounded-xl p-4 text-center'>
