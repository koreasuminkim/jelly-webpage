      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {targets.map((target, index) => (
            <div 
              key={index} 
              className={`animate-section stagger-${index + 1}`}
            >
              <div className="group relative bg-gray-900/50 rounded-2xl overflow-hidden hover:shadow-lg hover:shadow-blue-500/10 transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-3">
                    {target.features.map((feature, fIndex) => (
                      <li key={fIndex} className="text-gray-400 flex items-center gap-2 group-hover:text-gray-300 transition-colors">
